...
public class DigitRecognition {
    ...
    public static void main(String[] Args)
        ...
        File fXTrain = new File("/Users/kylethompson/Documents/MyProjects/SequentialNetwork/DigitData/trainingImages");
        File fYTrain = new File("/Users/kylethompson/Documents/MyProjects/SequentialNetwork/DigitData/trainLabels");
        File fXTest = new File("/Users/kylethompson/Documents/MyProjects/SequentialNetwork/DigitData/testingImages");
        File fYTest = new File("/Users/kylethompson/Documents/MyProjects/SequentialNetwork/DigitData/testLabels");
...
//        int[] inputShape = {xTrain[0].length, xTrain[0][0].length, xTrain[0][0][0].length};
        ...
        nn.load("/Users/kylethompson/Documents/WINTER2021/IND/StoredNets/AdamCrossE.txt");
        nn.save("/Users/kylethompson/Desktop/test.txt");
